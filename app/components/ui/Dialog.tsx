  ...
  return (
    <button
      className={classNames(
        'inline-flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-1 sm:py-2 rounded-lg text-xs sm:text-sm transition-colors',
        type === 'primary'
...
export const DialogTitle = memo(({ className, children, ...props }: RadixDialog.DialogTitleProps) => {
  return (
    <RadixDialog.Title
      className={classNames('text-sm sm:text-base md:text-lg font-medium text-bolt-elements-textPrimary flex items-center gap-1 sm:gap-2', className)}
      {...props}
    >
      {children}
    </RadixDialog.Title>
...
export const DialogDescription = memo(({ className, children, ...props }: RadixDialog.DialogDescriptionProps) => {
  return (
    <RadixDialog.Description
      className={classNames('text-xs sm:text-sm text-bolt-elements-textSecondary mt-1', className)}
      {...props}
    >
      {children}
    </RadixDialog.Description>
